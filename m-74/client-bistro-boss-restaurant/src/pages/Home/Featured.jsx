...
const Featured = () => {
  return (
    <div className="featured-item bg-fixed  pt-8 my-20">
      <SectionTile title="check it out" header="Featured Item"></SectionTile>
      <div className=" text-white md:flex justify-center items-center bg-slate-500 bg-opacity-60 pb-20 pt-12 px-36">
        <div>
